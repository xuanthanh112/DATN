...
<form action="{{ route('agency.destroy', $agency->id) }}" method="post" class="box">
    @csrf
    @method('DELETE')
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>Bạn đang muốn xóa đại lý có email là: {{ $agency->email }}</p>
                ...
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="row mb15">
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <label for="" class="control-label text-left">Tên đại lý</label>
                                    <input 
                                        type="text"
                                        name="name"
